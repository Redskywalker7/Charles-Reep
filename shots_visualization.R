...
# Change the formation variable to get different visualizations
formation = '41221'
...
socc_stadium + 
  ...
  geom_point(data = form_for, aes(x, y), color = '#2251b8') + 
  geom_point(data = form_for_goals, aes(x, y), color = 'Red') +
  geom_point(data = form_away, aes(x, y), color = '#fec52e') +
  geom_point(data = form_away_goals, aes(x, y), color = 'Red')
